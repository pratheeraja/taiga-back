...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunSQL(
            ...
            CREATE OR REPLACE FUNCTION get_random_color(bytea) RETURNS text AS $$
                SELECT concat('#', substring(encode(digest($1, 'sha1'), 'hex') from 0 for 7))
        ...
        migrations.RunSQL(
            """
                ...
                rebuilt_tags_colors AS (
                    SELECT tags.project_id project_id, array_agg_mult(ARRAY[[tags.tag, tags_colors.tags_colors[2]]]) tags_colors
                    FROM tags
        ...
        migrations.RunSQL(
            """
            CREATE OR REPLACE FUNCTION update_project_tags_colors() RETURNS trigger AS $update_project_tags_colors$
            DECLARE
            	tags text[];
            ...
            BEGIN
            	...
            	SELECT projects_project.tags_colors INTO project_tags_colors FROM projects_project WHERE id = project_id;
                ...
                IF tags IS NOT NULL THEN
                    ...
                    LOOP
                        IF tag != ALL(project_tags) THEN
                            project_tags_colors := array_cat(project_tags_colors, ARRAY[ARRAY[tag, get_random_color(tag::bytea)]]);
                        END IF;
                    END LOOP;
                END IF;
